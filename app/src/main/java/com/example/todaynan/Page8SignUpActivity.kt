...
class Page8SignUpActivity : AppCompatActivity() {
    ...
    private fun checkToNext() {
        if(binding.signupSelect1Dark.visibility == View.VISIBLE || binding.signupSelect2Dark.visibility == View.VISIBLE
            || binding.signupSelect3Dark.visibility == View.VISIBLE || binding.signupSelect4Dark.visibility == View.VISIBLE
            || binding.signupSelect5Dark.visibility == View.VISIBLE || binding.signupSelect6Dark.visibility == View.VISIBLE
            || binding.signupSelect7Dark.visibility == View.VISIBLE || binding.signupSelect8Dark.visibility == View.VISIBLE
            || binding.signupSelect9Dark.visibility == View.VISIBLE || binding.signupSelect10Dark.visibility == View.VISIBLE
            || binding.signupSelect11Dark.visibility == View.VISIBLE || binding.signupSelect12Dark.visibility == View.VISIBLE
            || binding.signupSelect13Dark.visibility == View.VISIBLE || binding.signupSelect14Dark.visibility == View.VISIBLE
            || binding.signupSelect15Dark.visibility == View.VISIBLE || binding.signupSelect16Dark.visibility == View.VISIBLE
            || binding.signupSelect17Dark.visibility == View.VISIBLE || binding.signupSelect18Dark.visibility == View.VISIBLE
            || binding.signupSelect19Dark.visibility == View.VISIBLE || binding.signupSelect20Dark.visibility == View.VISIBLE
            || binding.signupSelect21Dark.visibility == View.VISIBLE)
        {
            ...
            binding.signupNextBtnBefDark.visibility = View.INVISIBLE
            binding.signupNextBtnBef.visibility = View.VISIBLE
        }
    }
